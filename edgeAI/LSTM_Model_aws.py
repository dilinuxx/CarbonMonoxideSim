...
# --- Step 12: Export the model as a regular TensorFlow model (.h5) for server use (Amazon Linux / FastAPI) ---
model.save("co_lstm_regression_v1.h5")
print("✅ Saved model as TensorFlow .h5: co_lstm_regression_v1.h5")
